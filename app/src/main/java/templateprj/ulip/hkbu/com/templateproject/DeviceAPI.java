...
public class DeviceAPI {
    ...
    public static void playSound(String fName){
        try {
            ...
            soundPlayer.reset();
            AssetFileDescriptor f=activity.getAssets().openFd(fName);
            soundPlayer.setDataSource(f.getFileDescriptor(), f.getStartOffset(), f.getLength());
            soundPlayer.prepare();
            soundPlayer.start();
        } catch (Exception e) {
    ...
    public static double getSoundDuration(){
