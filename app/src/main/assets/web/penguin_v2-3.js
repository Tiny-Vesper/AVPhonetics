/*
PenguinJS v2.3
Copyright by Dave K.H.FUNG
Developed by Dave K.H.FUNG
*/
...
this.setBorderTopRadius=function(_radius){
box.style.borderRadius=_radius+'px '+_radius+'px 0px 0px';
}
...
this.setCloseBtnSize=function(_size){
if(_size!=null)closeBtn.style.fontSize=_size+'px';
}
...
_contentObject.style.height=93+'%';
